...
CREATE TABLE AmenitiesIncluded (listingId CHAR(10), tv CHAR(1), kitchen CHAR(1), internet CHAR(1), laundry CHAR(1), toiletries CHAR(1),
	PRIMARY KEY(listingId),
	FOREIGN KEY(listingId) REFERENCES ListingPostedIsIn ON DELETE CASCADE); 


CREATE TABLE Transaction(transactionId CHAR(10), price REAL, day DATE, listingId CHAR(10) NOT NULL,
	PRIMARY KEY (transactionId),
	FOREIGN KEY (listingId) REFERENCES ListingPostedIsIn,
	CHECK (price >= 0.00)); 

CREATE TABLE MakesReservation (reservationId CHAR(10), listingId CHAR(10) NOT NULL, status CHAR(10), checkindate DATE NOT NULL, checkoutdate DATE NOT NULL,  numberOfGuests INTEGER, transactionId CHAR(10) NOT NULL,
...
CREATE TABLE FulfillsReservation(reservationId CHAR (10), email VARCHAR (40) NOT NULL,
	PRIMARY KEY (reservationId),
	FOREIGN KEY (reservationId) REFERENCES MakesReservation,
	FOREIGN KEY (email) REFERENCES RegisteredUser);

CREATE TABLE WrittenReview(reviewId CHAR(10), ratingStars INTEGER, description VARCHAR (4000), day DATE, reservationId CHAR(10) NOT NULL,
